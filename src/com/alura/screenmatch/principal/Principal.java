...
public class Principal {
    public static void main(String[] args) {
        ...
        listaPeliculas.add(peliculaDeBruno);

        System.out.println("\nTamaño de lista de películas: " + listaPeliculas.size());
        System.out.println("Primera película de la lista: " + listaPeliculas.get(2).toString());
